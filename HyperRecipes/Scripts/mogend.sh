...
HUMAN_DIR="${PROJECT_DIR}/HyperRecipes/Models/Entities"
MACHINE_DIR="${PROJECT_DIR}/HyperRecipes/Models/EntitiesMachine"
INCLUDE_H="${PROJECT_DIR}/HyperRecipes/Models/ModelIncludes.h"
